  ...
  return (
    <div className="surface flex flex-col items-center gap-6 p-6">
      <div className="flex flex-col items-center gap-1">
        {tierA[0] && <AgentAvatar role={tierA[0].id} alt={tierA[0].name} status="running" size={44} />}
      ...
      <div className="grid grid-cols-5 gap-4">
        {tierA.slice(1).map((n) => (
          <div key={n.id} className="flex flex-col items-center gap-1 text-center">
            <AgentAvatar role={n.id} alt={n.name} status={n.status} size={36} />
      ...
      <div className="flex flex-wrap justify-center gap-3">
        {tierB.map((n) => (
          <div key={n.id} className="flex flex-col items-center gap-1 text-center">
            <AgentAvatar role={n.id} alt={n.name} status={n.status} size={28} />
