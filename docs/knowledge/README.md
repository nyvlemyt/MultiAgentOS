...
| `sommaire-que-l-IA-lit-avant-de-fouiller-sa-mémoire.md` | RES-056 intégral : SUMMARY.md | → memoire.md |
| `système-qui-fai-tourner-une-distribution-claude.md` | RES-053 intégral : archi distribution | → workflows.md |
| `Le Stack Doctrine.md` | RES-032 intégral : doctrine par-dessus framework | → project-doctrine.md |
| `3 checks a faire avant d'upgrader ton modele IA.md` | RES-031 intégral : checklist upgrade | → ADR 0002 |
