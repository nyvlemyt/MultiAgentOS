...
concern: testing
---
<!-- pattern from affaan-m/ecc rules/nuxt/testing.md -->

# Nuxt Testing

Testing standard for a registered Nuxt project. Extends `docs/rules/common/testing.md` and `docs/rules/vue/testing.md`.
...
- [Nuxt testing docs](https://nuxt.com/docs/getting-started/testing) · [@nuxt/test-utils npm](https://www.npmjs.com/package/@nuxt/test-utils)
