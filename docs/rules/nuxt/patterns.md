...
concern: patterns
---
<!-- pattern from affaan-m/ecc rules/nuxt/patterns.md -->

# Nuxt Patterns

Data-fetch, state, and server-route patterns for a registered Nuxt project. Extends `docs/rules/common/patterns.md` and `docs/rules/vue/patterns.md`.
...
- [Nuxt data fetching](https://nuxt.com/docs/getting-started/data-fetching) · [Nuxt state management](https://nuxt.com/docs/getting-started/state-management) · [Nitro](https://nuxt.com/docs/guide/directory-structure/server)
