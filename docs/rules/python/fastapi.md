...
concern: fastapi
---
<!-- pattern from affaan-m/ecc rules/python/fastapi.md -->

# Python — FastAPI Rules (reference)

Use alongside the general Python rules for FastAPI projects.
...
- `docs/rules/python/security.md`, `docs/rules/python/testing.md`.
