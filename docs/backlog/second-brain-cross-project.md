...
4. **Sous-feature : wiki thématique auto-entretenu (principe Karpathy)** — couche encyclopédique (articles par sujet, auto-grossis) distincte des 5 registres épisodiques, alimentée **en candidats** (Keeper seul écrit, §8), indexée par QMD (pas d'index manuel), synthèse plafonnée (§6). À traiter **dans** l'ADR candidat ci-dessus, pas en build-now. Audit : [`../intake/2026-06-27-karpathy-second-brain.md`](../intake/2026-06-27-karpathy-second-brain.md).
