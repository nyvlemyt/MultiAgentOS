...
- [`visual-effects-arsenal-intake-queue.md`](visual-effects-arsenal-intake-queue.md) — **file d'intake effets visuels (2026-07-13, reconstruite)** : 7 candidats en pyramide (react-three-fiber fondation → shadergradient/liquid → skiper-ui/vengenceui/animmasterlib), ordre d'audit + agents/skills d'exploitation + alerte sécurité 0xLoucash (1 lien injection à supprimer, 1 guide en quarantaine). Original `83fe731` jamais poussé depuis le poste Windows.
