 ...
 * runnable low-risk todo task `<missionId>_t1`. Single source of truth for the
 * dispatch-tick suites in both @mas/agents and apps/worker — keeps the seed out
 * of duplicated test boilerplate (Sonar new-code duplication).
 */
